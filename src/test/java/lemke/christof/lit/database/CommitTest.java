...
public class CommitTest {
    ...
    Commit commit = new Commit(Oid.ofNullable(null),Oid.of("88e38705fdbd3608cddbe904b67c731f3234c45b"), author, committer, "first commit");

    @Test
    public void testOid() {
        assertEquals("42f46a330ec74552df5bc383abf72931e194360d", commit.oid().value());
    }
}
